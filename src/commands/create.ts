...
export const createJSON = new SlashCommandBuilder()
	.setName('create')
	...
	.addStringOption((opt) =>
		opt.setName('emoji').setDescription('The emoji on the button the users press to enter the giveaway (default: 🎉)'),
	)
...
export async function create(res: FastifyReply, interaction: APIInteraction) {
